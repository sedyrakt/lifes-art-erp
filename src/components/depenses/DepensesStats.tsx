  ...
  return (<div className="relative mb-5 w-full">
    ...
    <div className="grid w-full grid-cols-1 gap-3 sm:grid-cols-2 xl:grid-cols-4">
      {stats.map((stat) => {
        ...
        return (<div key={stat.label} className="group relative min-h-[80px] rounded-lg border border-slate-300 bg-white px-4 py-3.5 shadow-sm ring-1 ring-transparent transition-all duration-200 hover:border-slate-400 hover:bg-slate-50 hover:ring-indigo-500/20 dark:border-slate-700 dark:bg-[#111c30] dark:hover:border-slate-600 dark:hover:bg-slate-800/50 dark:hover:ring-indigo-500/30">
