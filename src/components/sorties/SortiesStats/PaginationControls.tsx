// src/components/sorties/SortiesStats/PaginationControls.tsx
    ...
    >
      ...
      <div className="flex items-center gap-1">
        <button
          ...
          className="p-1.5 rounded-lg transition-colors disabled:opacity-30 hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer"
