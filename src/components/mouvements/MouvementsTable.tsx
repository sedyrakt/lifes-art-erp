...
import { Activity, ArrowDown, ArrowUp, CheckSquare, ChevronRight, Eye, MoreVertical, Package, TextSelection, Trash2 } from 'lucide-react';
              ...
              <td className={`border px-5 py-3 align-middle ${cellBorderColor}`}>
                <div className="flex min-w-0 items-center gap-3">
                  <div className="relative flex h-10 w-10 shrink-0 items-center justify-center overflow-hidden rounded-lg border border-slate-200 bg-slate-50 shadow-sm dark:border-slate-700 dark:bg-slate-800">
                    {imageUrl ? (<img src={imageUrl} alt={mouvement.produit_nom || 'Produit'} loading="lazy" className="h-full w-full object-cover transition-transform duration-200 group-hover:scale-105" />) : (<Package size={20} strokeWidth={1.8} className="text-indigo-500 dark:text-indigo-400" />)}
