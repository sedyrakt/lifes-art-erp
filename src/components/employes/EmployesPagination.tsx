// ============================================================
// src/components/employes/EmployesPagination.tsx - PREMIUM UI
// ============================================================
...
interface EmployesPaginationProps { 
  currentPage: number; 
  totalPages: number; 
  totalItems: number; 
...
const EmployesPagination: React.FC<EmployesPaginationProps> = ({ 
  ...
  return (
    <div className="mt-6 flex flex-col sm:flex-row items-center justify-between gap-4 px-2 w-full">
      {/* ⭐ Endrika Premium (Total mivaky havia) */}
      <div className="text-xs font-bold uppercase tracking-wider" style={{ color: theme.muted }}>
        Total : <span style={{ color: theme.text }} className="font-black">{totalItems}</span> employés
      </div>
...
export default EmployesPagination;