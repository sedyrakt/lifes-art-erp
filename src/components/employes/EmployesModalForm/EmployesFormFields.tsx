...
// ⭐ FormCell misy fandidiana loko mifototra amin'ny isDark
...
const EmployesFormFields: React.FC<EmployesFormFieldsProps> = ({ editingEmploye, isDark }) => {
  ...
  return (<div className="grid grid-cols-1 gap-x-4 gap-y-4 sm:grid-cols-2">
    <FormCell label="Prénom" required icon={<UserRound className="h-3.5 w-3.5" />} isDark={isDark}>
    ...
    <FormCell label="Nom" required icon={<UserRound className="h-3.5 w-3.5" />} isDark={isDark}>
    ...
    <FormCell label="Email" required icon={<Mail className="h-3.5 w-3.5" />} isDark={isDark}>
    ...
    <FormCell label="Téléphone" icon={<Phone className="h-3.5 w-3.5" />} isDark={isDark}>
    ...
    <FormCell label="Poste" required icon={<BriefcaseBusiness className="h-3.5 w-3.5" />} isDark={isDark}>
    ...
    <FormCell label="Département" icon={<Building2 className="h-3.5 w-3.5" />} isDark={isDark}>
    ...
    <FormCell label="Date d'embauche" icon={<CalendarDays className="h-3.5 w-3.5" />} isDark={isDark}>
    ...
    <FormCell label="Salaire" required icon={<DollarSign className="h-3.5 w-3.5" />} isDark={isDark}>
    ...
    <FormCell label="Statut" icon={<Activity className="h-3.5 w-3.5" />} fullWidth isDark={isDark}>
      <div className="relative">
