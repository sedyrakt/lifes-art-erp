...
const Categories: React.FC = () => {
  ...
  return (<main className="min-h-full w-full transition-colors duration-200" style={{ background: isDark ? '#0F172A' : '#F8FAFC' }}><div className="mx-auto w-full max-w-[1600px] px-4 py-5 lg:px-5">
